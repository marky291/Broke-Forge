            ...
            <div className="rounded-xl border bg-background p-6">
                ...
                <div className="space-y-4">
                    {latestProgress.map((event) => {
                        ...
                        return (
                            <div 
                                key={event.service_type}
                                className={`rounded-lg border p-4 transition-colors ${statusConfig.bgColor}`}
                            >
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                {event.details?.label || event.milestone}
                                            </p>
                                        </div>
                                    </div>
                                ...
                                {isActive && (
                                    <div className="mt-3">
                                        ...
                                        <div className="flex justify-between text-xs text-muted-foreground mt-1">
                                            <span>Step {event.current_step} of {event.total_steps}</span>
