        ...
        return [
            ...
            'steps' => [
                ...
                [
                    ...
                    'description' => 'Preparing your server and setting up server requirements.',
                    'status' => $this->getStepStatus($provision, 2),
                ],
                [
                    'step' => 3,
                    'name' => 'Checking Status',
                    'description' => 'We are validating your server and connection information is accurate.',
                ...
                [
                    ...
                    'status' => $this->getStepStatus($provision, 8),
                ],
            ],
        ];
    }
