...
class UpdateServerMonitorRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        return $monitor && $monitor->user_id === $this->user()->id;
    }
