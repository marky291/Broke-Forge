...
class MariaDbUpdaterMilestones extends Milestones
{
    ...
    public const UPGRADE_MARIADB = 'upgrade_mariadb';
    ...
    private const LABELS = [
        ...
        self::UPGRADE_MARIADB => 'Switching MariaDB version',
        self::START_SERVICE => 'Starting MariaDB service',
        self::RUN_MYSQL_UPGRADE => 'Running mysql_upgrade',
        self::VERIFY_UPDATE => 'Verifying MariaDB update',
