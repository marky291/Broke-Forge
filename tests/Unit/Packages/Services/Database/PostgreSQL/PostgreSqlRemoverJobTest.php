...
class PostgreSQLRemoverJobTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_job_has_correct_timeout_property(): void
    {
        ...
        // Act
        $job = new PostgreSQLRemoverJob($server, $database->id);
    ...
    public function test_constructor_accepts_server_and_database_id(): void
    {
        ...
        // Act
        $job = new PostgreSQLRemoverJob($server, $databaseId);

        // Assert
        $this->assertInstanceOf(PostgreSQLRemoverJob::class, $job);
    ...
    public function test_failed_method_stores_error_log(): void
    {
        ...
        $job = new PostgreSQLRemoverJob($server, $database->id);
        $errorMessage = 'PostgreSQL removal timeout error';
    ...
    public function test_failed_method_handles_missing_records_gracefully(): void
    {
        ...
        $job = new PostgreSQLRemoverJob($server, $nonExistentId);
