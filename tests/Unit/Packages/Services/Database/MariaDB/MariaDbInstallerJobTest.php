...
namespace Tests\Unit\Packages\Services\Database\MariaDB;
...
class MariaDBInstallerJobTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_job_has_correct_timeout_property(): void
    {
        ...
        // Act
        $job = new MariaDBInstallerJob($server, $database->id);
    ...
    public function test_constructor_accepts_server_and_database_id(): void
    {
        ...
        // Act
        $job = new MariaDBInstallerJob($server, $databaseId);

        // Assert
        $this->assertInstanceOf(MariaDBInstallerJob::class, $job);
    ...
    public function test_failed_method_stores_error_log(): void
    {
        ...
        $job = new MariaDBInstallerJob($server, $database->id);
        $errorMessage = 'MariaDB installation timeout error';
    ...
    public function test_failed_method_handles_missing_records_gracefully(): void
    {
        ...
        $job = new MariaDBInstallerJob($server, $nonExistentId);
    ...
    public function test_failed_method_preserves_database_record_data(): void
    {
        ...
        $database->refresh();
        $this->assertEquals('mariadb', $database->name);
